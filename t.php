            ...
            <div class="row align-items-center">
                ...
                <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                	...
                	<nav class="grid__item"   id="AccessibleNav"><!-- for mobile -->
                        ...
                        <li class="lvl1 parent megamenu"><a href="./PRODUCTS CATEGORY.html">Product <i class="anm anm-angle-down-l"></i></a>
                        </li>
                        <li class="lvl1"><a href="./PRODUCTS CATEGORY.html"><b>Buy Now!</b> <i class="anm anm-angle-down-l"></i></a></li>
                      </ul>
                    </nav>
                    <!--End Desktop Menu-->
                </div>
                        ...
                        <div class="slideshow__text-wrap slideshow__overlay classic bottom">
                            <div class="slideshow__text-content bottom">
                                <div class="wrap-caption center">
                                    ...
                                    <span class="btn"><a href="./PRODUCT DESCRIPTION.html"> Shop Now</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="productSlider" style="background-color: black;">
                                        <div class="col-12 item" style="background-color: black;">
                                            ...
                                            <div class="product-image" style="background-color: black;">
                                                ...
                                                <a href="PRODUCT DESCRIPTION.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="" src="./Women/female-model-with-curly-hair-wearing-tshirt-mockup-00166.png" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="" src="./Women/female-model-with-curly-hair-wearing-tshirt-mockup-00166.png" alt="image" title="product">
                                                    <!-- End hover image -->
                                                    <!-- product label -->
                                            ...
                                            <div class="product-details text-center">
                                                ...
                                                <div class="product-name">
                                                    <a href="PRODUCT DESCRIPTION.html" style="color: rgb(245, 245, 250);">Edna Dress</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                                    <span class="price" style="color: rgb(238, 238, 245);">$600.00</span>
                                                </div>
                                                <!-- End product price -->
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="PRODUCT DESCRIPTION.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="" src="./Women/woman-tshirt-mockup-oversized-0048.png" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="" src="./Women/woman-tshirt-mockup-oversized-0048.png" alt="image" title="product">
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="PRODUCT DESCRIPTION.html" style="color: rgb(247, 247, 250);">Elastic Waist Dress</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                                    <span class="price" style="color: rgb(239, 239, 243);">$748.00</span>
                                                </div>
                                                <!-- End product price -->
                                                <div class="product-review">
                                                    <i class="font-13 fa fa-star"></i>
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="PRODUCT DESCRIPTION.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="" src="./Women/woman-tshirt-mockup-closeup-with-plain-background-0021.png" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="" src="./Women/woman-tshirt-mockup-closeup-with-plain-background-0021.png" alt="image" title="product">
                                                    <!-- End hover image -->
                                                    <!-- product label -->
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="PRODUCT DESCRIPTION.html" style="color: rgb(243, 243, 248);">3/4 Sleeve Kimono Dress</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                                    <span class="price" style="color: rgb(242, 242, 247);">$550.00</span>
                                                </div>
                                                <!-- End product price -->
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="PRODUCT DESCRIPTION.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="" src="./Women/woman-curly-hair-tshirt-mockup-in-front-of-textured-wall-for-graphic-design-0014.png" alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="" src="./Women/woman-curly-hair-tshirt-mockup-in-front-of-textured-wall-for-graphic-design-0014.png" alt="image" title="product" />
                                                    <!-- End hover image -->
                                                    <!-- product label -->
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="PRODUCT DESCRIPTION.html" style="color: rgb(244, 244, 250);">Cape Dress</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                                    <span class="price" style="color: rgb(245, 245, 252);">$788.00</span>
                                                </div>
                                                <!-- End product price -->
				...
				<div class="collection-grid" style="background-color: rgb(3, 3, 3);">
                        <div class="collection-grid-item">
                            <a href="PRODUCTS CATEGORY.html" class="collection-grid-item__link">
                                <img data-src="" src="./Women/female-model-with-curly-hair-wearing-tshirt-mockup-00166.png" alt="Fashion" class="blur-up lazyload"/>
